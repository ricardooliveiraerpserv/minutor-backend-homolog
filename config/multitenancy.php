...
return [
     ...
     */
    'switch_tenant_tasks' => [
        // Isola as TABELAS via search_path do Postgres (schema-per-tenant, mesmo banco).
        \App\Multitenancy\SwitchTenantSchemaTask::class,
        // Isola o CACHE prefixando as chaves por tenant (resolve o item de cache da auditoria).
