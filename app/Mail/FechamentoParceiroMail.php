...
/**
 * E-mail do fechamento de parceiro.
 *
 ...
 */
class FechamentoParceiroMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        // Reply-To = QUEM ENVIOU + FINANCEIRO: a resposta do parceiro (um "Responder"
    ...
    {
        return new Content(
            view: 'emails.fechamento.parceiro',
            with: [
