...
class MovideskService
{
    ...
    public function reprocessTimesheet(\App\Models\Timesheet $timesheet): array
    {
        ...
        // Trava manual: se o usuário editou qualquer campo de conteúdo
        // (cliente/projeto/data/horários/effort/observação) via UI, o
        // reprocess NÃO sobrescreve mais. Edições do Minutor têm prioridade.
