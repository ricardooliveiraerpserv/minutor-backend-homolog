...
class SignatureRenderer
{
    ...
    public static function render(array $d, string $iconMode = 'data', bool $showPhoto = true, string $theme = 'light', bool $showTagline = true): string
    {
        ...
        if (($d['brand'] ?? '') === 'conecta') {
            ...
            $chevCell = $chev !== ''
                ? '<td valign="middle" width="112" style="width:112px;vertical-align:middle;padding-right:16px"><img src="' . $chev . '" width="102" height="132" border="0" style="width:102px;height:132px;display:block;border:0;outline:none" /></td>'
