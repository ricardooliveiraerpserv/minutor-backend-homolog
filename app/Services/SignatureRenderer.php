...
class SignatureRenderer
{
    ...
    public static function render(array $d, string $iconMode = 'data', bool $showPhoto = true, string $theme = 'light', bool $showTagline = true): string
    {
        ...
        if (($d['brand'] ?? '') === 'conecta') {
            ...
            $chevCell = $chev !== ''
                ? '<td valign="middle" width="88" style="width:88px;vertical-align:middle;padding-right:18px"><img src="' . $chev . '" width="79" height="150" border="0" style="width:79px;height:150px;display:block;border:0;outline:none" /></td>'
