    ...
    public function login(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'user' => array_merge($user->toArray(), [
                ...
                'modules'                 => \App\Models\NavModule::keysForProfile($user),
                'allowed_modules'         => $user->allowedModulesList(),
                'is_helpdesk_agent'       => $user->isHelpDeskAgent(),
                'helpdesk_default_screen' => app(\App\Services\HelpDeskAccessPolicy::class)->defaultScreen($user),
