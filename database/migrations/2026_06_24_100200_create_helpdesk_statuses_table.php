    ...
    public function up(): void
    {
        ...
        if (DB::table('helpdesk_statuses')->count() === 0) {
            DB::table('helpdesk_statuses')->insert([
                ...
                ['key' => 'em_andamento',       'label' => 'Em atendimento',       'color' => '#6366f1', 'sort_order' => 20, 'is_default' => false, 'is_open' => true,  'is_resolved' => false, 'is_terminal' => false, 'sla_paused' => false, 'active' => true, 'created_at' => now(), 'updated_at' => now()],
