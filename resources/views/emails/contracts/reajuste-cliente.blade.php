        ...
        <tr>
          <td align="left" bgcolor="#FFFFFF" style="padding:30px 40px 8px;">
            ...
            <p style="margin:0 0 14px;color:#334155;font-size:14px;line-height:1.65;">
              ...
              Este é o <b>valor consolidado</b>, que passa a vigorar a partir da data indicada abaixo.
            </p>
            @else
            <p style="margin:0 0 14px;color:#334155;font-size:14px;line-height:1.65;">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"
              ...
              <tr>
                <td style="padding:18px 22px;">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td style="color:#64748B;font-size:13px;padding:4px 0;">{{ $estorno ? 'Valor reajustado (estornado)' : 'Valor anterior' }}</td>
                      <td align="right" style="color:#64748B;font-size:14px;padding:4px 0;{{ $estorno ? '' : 'text-decoration:line-through;' }}">{{ $brl($valorAnterior) }}</td>
                    </tr>
                    <tr>
                      <td style="color:#0F172A;font-size:14px;font-weight:700;padding:4px 0;">{{ $estorno ? 'Valor restabelecido' : 'Novo valor' }}</td>
