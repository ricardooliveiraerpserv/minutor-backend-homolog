<!doctype html>
<html lang="pt-br">
<head><meta charset="utf-8"><title>{{ $codigo }} — Você é coordenador(a)</title></head>
  ...
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"
    ...
    <tr>
      <td style="padding:32px 40px 4px;background:#000000;">
        <div style="font-size:11px;letter-spacing:.22em;color:{{ $accent ?? '#A3E635' }};font-weight:800;text-transform:uppercase;">Coordenação atribuída</div>
        <h1 style="margin:8px 0 4px;color:#FFFFFF;font-size:23px;line-height:1.3;font-weight:800;">
          Você é o(a) coordenador(a) deste projeto
        </h1>
        <p style="margin:0;color:#D4D4D8;font-size:14px;line-height:1.55;">
          O projeto <b style="color:#FFFFFF;">{{ $codigo }}</b> foi atribuído a você e está pronto para iniciar.
        </p>
      </td>
    </tr>
    ...
    <tr>
      <td style="padding:18px 40px 0;background:#000000;">
        <div style="background-color:#15151A;border:1px solid #3F3F46;border-radius:12px;padding:22px;">
          <div style="font-size:10px;letter-spacing:.24em;color:{{ $accent ?? '#A3E635' }};font-weight:800;text-transform:uppercase;margin-bottom:14px;">Dados do projeto</div>
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
            ...
            <tr>
              ...
              <td style="color:#FFFFFF;padding:5px 0;font-weight:700;">
                <span style="display:inline-block;background-color:{{ $accent ?? '#A3E635' }};color:#000000;font-size:11px;font-weight:800;padding:6px 12px;border-radius:999px;letter-spacing:.06em;">PRONTO PARA INICIAR</span>
              </td>
            </tr>
          </table>
        </div>
    ...
    <tr>
      <td style="padding:24px 40px 8px;background:#000000;">
        <a href="{{ $cardUrl }}" style="display:inline-block;background:{{ $accent ?? '#A3E635' }};color:#000000;text-decoration:none;font-weight:800;font-size:13px;padding:13px 26px;border-radius:8px;">Abrir Projeto</a>
      </td>
    </tr>
    ...
    <tr>
      <td style="padding:24px 40px 32px;background:#000000;color:#D4D4D8;font-size:12px;line-height:1.7;border-top:1px solid #3F3F46;">
        Olá, {{ $recipientName }}. Você foi designado(a) como coordenador(a) deste projeto — pode iniciá-lo.
        <br><br>
