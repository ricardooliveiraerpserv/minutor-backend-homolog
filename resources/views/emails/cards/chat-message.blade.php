  ...
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"
    ...
    <tr>
      <td style="padding:32px 40px 4px;background:#000000;">
        <div style="font-size:11px;letter-spacing:.22em;color:{{ $accent ?? '#22D3EE' }};font-weight:800;text-transform:uppercase;">{{ $eyebrow }}</div>
    ...
    <tr>
      <td style="padding:18px 40px 0;background:#000000;">
        <div style="background-color:#15151A;border-left:4px solid {{ $accent ?? '#22D3EE' }};padding:18px 20px;border-radius:0 12px 12px 0;border-top:1px solid #3F3F46;border-right:1px solid #3F3F46;border-bottom:1px solid #3F3F46;">
    ...
    <tr>
      <td style="padding:24px 40px 8px;background:#000000;">
        <a href="{{ $openUrl }}" style="display:inline-block;background:{{ $accent ?? '#22D3EE' }};color:#000000;text-decoration:none;font-weight:800;font-size:13px;padding:13px 26px;border-radius:8px;">Abrir conversa</a>
        <a href="{{ $cardUrl }}" style="display:inline-block;color:{{ $accent ?? '#22D3EE' }};text-decoration:none;font-weight:700;font-size:13px;padding:13px 18px;margin-left:6px;">Ver {{ $cardType === 'contract_request' ? 'requisição' : 'projeto' }}</a>
      </td>
    </tr>
