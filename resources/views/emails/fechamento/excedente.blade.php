...
<head>
  ...
  <title>Horas Excedentes — {{ $periodo }}</title>
  <!--[if mso]>
  <noscript>
        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600"
          ...
          <tr>
            <td class="pd-main" align="left" bgcolor="#FFFFFF" style="padding:36px 40px 0;background-color:#FFFFFF;">
              <div style="font-size:11px;letter-spacing:.18em;color:#0E7490;font-weight:700;text-transform:uppercase;">Horas Excedentes</div>
                      ...
                      <tr>
                        ...
                        <td style="vertical-align:middle;">
                          <div style="font-size:13px;color:#CBD5E1;line-height:1.5;">
                            O arquivo anexo (<strong style="color:#FFFFFF;">PDF</strong>) contém o detalhamento completo
                            da apuração das horas excedentes no período.
                          </div>
                        </td>
                      </tr>
                    </table>
